...
(function(){
  ...
  function baseStage(id,n,w,h){
    return {id,name:CAMPAIGN_TEMPLATE_CONFIG[id].name,playerCount:n,width:w,height:h,map:makeBase(w,h),blocks:[],lasers:[],buttons:[],keys:[],doors:[],jumppads:[],bindPlayers:false,shieldRule:null,spawn:pos(2,h-3),description:''};
  }
